...
var Defs = []KeyDef{
	...
	{Key: GatewayChatImageThinkingStrategy, Type: "string", Category: "gateway", Default: "picture_v2_thinking", Label: "思考生图策略", Desc: "picture_v2_thinking=默认稳定模式; native_thinking=兼容回滚"},

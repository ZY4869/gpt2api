...
[![Release](https://img.shields.io/badge/release-v0.5.19-brightgreen?style=flat-square)](https://github.com/432539/gpt2api/releases)
...
> 当前默认版本：`v0.5.19`，作为当前 fork 的发布线；上游 `v2.x` 仍保留为新架构参考基线。
